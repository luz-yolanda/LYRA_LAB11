...
#                  #
####################
# Hecho con gusto por LUZ YOLANDA RIVERA ALVAREZ(UAEH)
...
M = as.matrix(
  read.csv("/Users/luz/Documents/Doctorado/Materias/Complejidad Económica/Entregables /Semana 4/Laboratorios/Lab 11/relatednessbinario.csv" , 
           sep = ",", 
           header = T, 
           row.names = 1))
